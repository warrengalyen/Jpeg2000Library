...
namespace Jpeg2000Library.Util
{
    ...
    public class MathUtil
    {
        ...
        public static int lcm(int x1, int x2)
        {
            if (x1 <= 0 || x2 <= 0)
            {
                throw new ArgumentException("Cannot compute the least " +
            ...
            throw new Exception("Cannot find the least common multiple of numbers " +
                            x1 + " and " + x2);
        }
        ...
        public static int lcm(int[] x)
        {
            if (x.Length < 2)
            {
                throw new Exception("Do not use this method if there are less than" +
                                " two numbers.");
            }
        ...
        public static int gcd(int x1, int x2)
        {
            if (x1 < 0 || x2 < 0)
            {
                throw new ArgumentException("Cannot compute the GCD " +

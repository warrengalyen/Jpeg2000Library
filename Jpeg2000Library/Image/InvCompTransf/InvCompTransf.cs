...
namespace Jpeg2000Library.Image.Invcomptransf
{
    ...
    public class InvCompTransf : ImgDataAdapter, BlkImgDataSrc
    {
        ...
        private const string[][] pinfo = null;
        ...
        public InvCompTransf(BlkImgDataSrc imgSrc, DecoderSpecs decSpec,
                             int[] utdepth, ParameterList pl) : base(imgSrc)
        {
        ...
        public override string ToString()
        {
            switch (transfType)
            {
                ...
                default:
                    throw new ArgumentException("Non JPEG 2000 part I" +
         ...
         * */
        public new int getNomRangeBits(int c)
        {
            return utdepth[c];
        }
     ...
     *
     * */
        public new void setTile(int x, int y)
        {
            src.setTile(x, y);
            ...
            else
            {
                ...
                {
                    // Error
                    throw new ArgumentException("Wavelet transformation and " +
                                                       "component transformation" +

 ...
 *  */
namespace Jpeg2000Library.Wavelet.Synthesis
{
    ...
    public class SynWTFilterFloatLift9x7 : SynWTFilterFloat
    {
         ...
         * */
        public override void synthetize_hpf(float[] lowSig, int lowOff, int lowLen, int lowStep,
                    float[] highSig, int highOff, int highLen,
         ...
         * @return 2
         * */
        public override int getAnLowNegSupport()
        {
            return 4;
        }
         ...
         * positive direction
         * */
        public override int getAnLowPosSupport()
        {
            return 4;
        }
         ...
         * */
        public override int getAnHighNegSupport()
        {
            return 3;
        }
         ...
         * positive direction
         * */
        public override int getAnHighPosSupport()
        {
            return 3;
        }
         ...
         * negative direction
         * */
        public override int getSynLowNegSupport()
        {
            return 3;
        }
         ...
         * positive direction
         * */
        public override int getSynLowPosSupport()
        {
            return 3;
        }
         ...
         * negative direction
         * */
        public override int getSynHighNegSupport()
        {
            return 4;
        }
         ...
         * positive direction
         * */
        public override int getSynHighPosSupport()
        {
            return 4;
        }
         ...
         * */
        public override int getImplType()
        {

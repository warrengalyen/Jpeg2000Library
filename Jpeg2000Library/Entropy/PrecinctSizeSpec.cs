...
namespace Jpeg2000Library.Entropy
{
    ...
    public class PrecinctSizeSpec : ModuleSpec
    {
        ...
        public PrecinctSizeSpec(int nt, int nc, byte type, BlkImgDataSrc imgsrc,
                              IntegerSpec dls, ParameterList pl) : base(nt, nc, type)
        {
            ...
            List<int>[] tmpv = new List<int>[2];
            tmpv[0] = new List<int>(); // ppx
            tmpv[0].Add(Markers.PRECINCT_PARTITION_DEF_SIZE);
            tmpv[1] = new List<int>(); // ppy
                  ...
                  !endOfParamList)
            {
                ...
                List<int>[] v = new List<int>[2]; // v[0] : ppx, v[1] : ppy
                ...
                switch (word[0])
                {
                    ...
                    default:
                        ...
                        v[0] = new List<int>(); // ppx
                        v[1] = new List<int>(); // ppy
